...
//     return {
//       ...localStyles.slide,
//       position: "relative", // Changed from absolute to allow document flow
//       display: isActive ? "flex" : "none", // Only show active slide content
//       opacity: isActive ? 1 : 0,
//       width: "100%",
//     };
//   }
...
// const images = {
//   imports: process.env.PUBLIC_URL + "/import.jpg",
//   exports: process.env.PUBLIC_URL + "/export.jpg",
//   feed: process.env.PUBLIC_URL + "/feedone.jpeg",
//   hcp: process.env.PUBLIC_URL + "/hcp.jpeg",
//   prawn: process.env.PUBLIC_URL + "/prawn.jpg",
//   fish: process.env.PUBLIC_URL + "/fish.jpg",
//   shrimp: process.env.PUBLIC_URL + "/shrimp.jpg",
//   minerals: process.env.PUBLIC_URL + "/minerals.jpg",
//   chemicals: process.env.PUBLIC_URL + "/chemicals.jpg",
// };
//   return (
...
//               <div style={localStyles.imageWrapper}><img src={images.feed} style={localStyles.importExportImg} alt="Feed" /></div>
...
//               <div style={localStyles.imageWrapper}><img src={images.hcp} style={localStyles.importExportImg} alt="HCP" /></div>
  ...
  const getSlideStyle = (index) => {
    ...
    if (isMobile) {
      return {
        ...localStyles.slide,
        position: isActive ? "relative" : "absolute",
        display: isActive ? "flex" : "none", // Hide inactive slides completely
    ...
    <div style={localStyles.app}>
      ...
      <section id="imports-exports" style={localStyles.importExportSection}>
        ...
        <div style={localStyles.sliderWrapper}>
          ...
          {/* SLIDE 3 (Long List Example) */}
          <div style={getSlideStyle(3)}>
            {["OXY-BESTOT", "GUTPRO", "ENGRO", "UNI-LIGHT", "NURI BSL", "ZEOLITE", "SAPONIN", "HC-BIO"].map((item) => (
              <div key={item} style={localStyles.importExportCard}>
                <div style={localStyles.imageWrapper}><img src={commonImg} alt={item} style={localStyles.importExportImg} /></div>
                <div style={localStyles.cardContent}><h3>{item}</h3></div>
              </div>
            ))}
...
const navStyles = {
  ...
  logoImg: { height: "50px", width: "185px", objectFit: "contain", cursor: "pointer" },
  nav: { display: "flex", alignItems: "center", gap: "20px" },
  navLink: { color: "#1a365d", fontWeight: "bold", fontSize: "16px", cursor: "pointer", textDecoration: "none" },
  hamburger: { fontSize: "32px", cursor: "pointer" },
  navOpen: { position: "absolute", top: "70px", left: 0, width: "100%", background: "#fff", flexDirection: "column", padding: "20px" },
};

const styles = {
  footer: { background: "#0d1b2a", color: "#fff", padding: "20px", textAlign: "center", marginTop: "20px" },
  footerTop: { display: "flex", justifyContent: "center", gap: "25px", flexWrap: "wrap" },
  footerBottom: { marginTop: "5px", fontSize: "12px", opacity: 0.8 },
};
...
const localStyles = {
  ...
  sliderWrapper: {
    position: "relative",
    width: "100%",
    minHeight: "400px", // Give it a base height
    display: "flex",
    justifyContent: "center",
  },
  slide: {
